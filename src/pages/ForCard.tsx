...
import currencies from '../assets/currency.png'

export default function ForCard() {
    return (
        <div className="my-12 grid lg:grid-cols-2 m-4 md:mx-8 lg:mx-14 gap-8 md:gap-12 lg:gap-16">
            <div className="grid items-center">
                <h1 className='text-2xl md:text-4xl my-2 font-bold leading-relaxed'>Card Title</h1>
                <div className="h-full">
                    <img src={currencies} className='h-full' alt="" />
                </div>
            </div>
            <div className='mt-2'>
                <form className="">
